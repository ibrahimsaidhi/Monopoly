...
public class Board {
    ...
    public void buildBoard(){
        ...
        board.add(5, new Property("Reading Railroad", "blank", 200));
        ...
        board.add(12, new Property("Electric Company", "blank", 150));
        board.add(13, new Property("States Ave", "purple", 140));
        board.add(14, new Property("Virginia Ave", "purple", 160));
        board.add(15, new Property("Pennsylvania Railroad", "blank", 200));
        ...
        board.add(35, new Property("Short Line", "blank", 200));
